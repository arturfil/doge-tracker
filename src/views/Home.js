...
const Home = () => {
  ...
  let clients = [
    ...
    {"id":32, name: "Kevin",	  asset: "DOGE",	price: 0.174706, quantity: 572, agent: 'Kevin' },
    ...
    {"id":15, name: "Arturo",	  asset: "DOGE",	price: 0.312666, quantity: 1422, agent: 'Arturo' },
    {"id":15, name: "Arturo",	  asset: "DOGE",	price: 0.4603,    quantity: 864, agent: 'Arturo' },
    {"id":15, name: "Arturo",	  asset: "DOGE",	price: 0.25,     quantity: 4000, agent: 'Arturo' },
    ...
    {"id":31, name: "Pelos",	  asset: "DOGE",	price: 0.173736, quantity: 575, agent: 'Kevin' },
    ...
    {"id":23, name: "Jake",	    asset: "DOGE",	price: 0.197966, quantity: 761, agent: 'Kevin' },
